...
class OpenAICompatibleSTTEntity(SpeechToTextEntity):
    ...
    def _clean_transcription(self, text: str) -> str:
        """Remove unwanted annotations from transcription text."""
    ...
    async def async_process_audio_stream(
        ...
        try:
            with tempfile.NamedTemporaryFile(delete=False, suffix=".wav") as temp_file:
                ...
                # Remove non-word transcriptions generated by some models
                cleaned_text = self._clean_transcription(transcription.text)

                # Only return a result if there's actual text after cleaning
                if cleaned_text:
                    return SpeechResult(cleaned_text, SpeechResultState.SUCCESS)
                return SpeechResult("", SpeechResultState.ERROR)
